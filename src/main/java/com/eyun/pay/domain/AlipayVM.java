...
public class AlipayVM {
	 ...
	 */
	@ApiModelProperty(value="对一笔交易的具体描述信息。如果是多种商品，请将商品描述字符串累加传给body",required=true,example="Iphone6 16G")
	private String body;
	 ...
	 * 商户网站唯一订单号
	 */
	@ApiModelProperty(value="唯一订单号",required=true,example="1201805011205123456")
	 ...
	 */
	@ApiModelProperty(value="商品的标题/交易标题/订单标题/订单关键字等",required=true,example="iPhoneX 黑色 258g 三网通")
	private String subject;

	/**
	 * 绝对超时时间，格式为yyyy-MM-dd HH:mm。
	 */
	@ApiModelProperty(value="绝对超时时间，格式为yyyy-MM-dd HH:mm",required=true,example="2018-05-01 19:06")
	 ...
	 */
	@ApiModelProperty(
			value="该笔订单允许的最晚付款时间，逾期将关闭交易。取值范围：1m～15d。m-分钟，h-小时，d-天，1c-当天（1c-当天的情况下，无论交易何时创建，都在0点关闭）。 该参数数值不接受小数点， 如 1.5h，可转换为 90m",
			required=true,
			example="15m")
	 ...
	 */
	@ApiModelProperty(
			value="订单总金额，单位为元，精确到小数点后两位，取值范围[0.01,100000000]",
			required=true,
			example="100")
